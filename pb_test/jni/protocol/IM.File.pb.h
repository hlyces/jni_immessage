...
// repeated .IM.BaseDefine.IpAddr ip_addr_list = 10;
inline int IMFileAddOfflineReq::ip_addr_list_size() const {
  return ip_addr_list_.size();
}
inline void IMFileAddOfflineReq::clear_ip_addr_list() {
  ip_addr_list_.Clear();
}
inline const ::IM::BaseDefine::IpAddr& IMFileAddOfflineReq::ip_addr_list(int index) const {
  // @@protoc_insertion_point(field_get:IM.File.IMFileAddOfflineReq.ip_addr_list)
  return ip_addr_list_.Get(index);
}
inline ::IM::BaseDefine::IpAddr* IMFileAddOfflineReq::mutable_ip_addr_list(int index) {
  // @@protoc_insertion_point(field_mutable:IM.File.IMFileAddOfflineReq.ip_addr_list)
  return ip_addr_list_.Mutable(index);
}
inline ::IM::BaseDefine::IpAddr* IMFileAddOfflineReq::add_ip_addr_list() {
  // @@protoc_insertion_point(field_add:IM.File.IMFileAddOfflineReq.ip_addr_list)
  return ip_addr_list_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::IM::BaseDefine::IpAddr >&
IMFileAddOfflineReq::ip_addr_list() const {
  // @@protoc_insertion_point(field_list:IM.File.IMFileAddOfflineReq.ip_addr_list)
  return ip_addr_list_;
}
inline ::google::protobuf::RepeatedPtrField< ::IM::BaseDefine::IpAddr >*
IMFileAddOfflineReq::mutable_ip_addr_list() {
  // @@protoc_insertion_point(field_mutable_list:IM.File.IMFileAddOfflineReq.ip_addr_list)
  return &ip_addr_list_;
}
