...
class IMLoginRes : public ::google::protobuf::MessageLite {
 public:
  ...
  static const int kUserTokenFieldNumber = 10;
...
// optional string user_token = 10;
inline bool IMLoginRes::has_user_token() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void IMLoginRes::set_has_user_token() {
  _has_bits_[0] |= 0x00000020u;
}
inline void IMLoginRes::clear_has_user_token() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void IMLoginRes::clear_user_token() {
  if (user_token_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_->clear();
  }
  clear_has_user_token();
}
inline const ::std::string& IMLoginRes::user_token() const {
  // @@protoc_insertion_point(field_get:IM.Login.IMLoginRes.user_token)
  return *user_token_;
}
inline void IMLoginRes::set_user_token(const ::std::string& value) {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  user_token_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Login.IMLoginRes.user_token)
}
inline void IMLoginRes::set_user_token(const char* value) {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  user_token_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Login.IMLoginRes.user_token)
}
inline void IMLoginRes::set_user_token(const char* value, size_t size) {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  user_token_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Login.IMLoginRes.user_token)
}
inline ::std::string* IMLoginRes::mutable_user_token() {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Login.IMLoginRes.user_token)
  return user_token_;
}
inline ::std::string* IMLoginRes::release_user_token() {
  clear_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void IMLoginRes::set_allocated_user_token(::std::string* user_token) {
  if (user_token_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete user_token_;
  }
  if (user_token) {
